...
import type {
  AgendamentoAulaCriarADReponse,
  AgendamentoAulaCriarADRequest,
  AgendamentoAulaCriarRequest,
  AgendamentoAulaEditarRequest,
} from '../../types/agendamentoAula.type';
...
export class AgendamentoService {
  ...
  public editAgendamentoAula(
    agendamentoAulaId: number,
    agendamento: AgendamentoAulaEditarRequest,
  ...
  public criarAgendamentoAulaAD(
    agendamento: AgendamentoAulaCriarADRequest,
  ): Observable<AgendamentoAulaCriarADReponse> {
    return this.http.post<AgendamentoAulaCriarADReponse>(
      `${this.baseUrl}/aulas/auxiliar-docente`,
      agendamento,
    );
  }

  public criarAgendamentoAulaRecorrente(
    agendamento: AgendamentoRecorrente,
  ): Observable<AgendamentoRecorrente> {

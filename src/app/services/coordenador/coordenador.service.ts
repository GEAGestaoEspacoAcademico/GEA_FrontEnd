...
import type {
  CriarCoordenadorRequest,
  CriarCoordenadorResponse,
} from '../../types/coordenador.type';
...
export class CoordenadorService {
  ...
  public criarCoordenador(
    coordenador: CriarCoordenadorRequest,
  ): Observable<CriarCoordenadorResponse> {

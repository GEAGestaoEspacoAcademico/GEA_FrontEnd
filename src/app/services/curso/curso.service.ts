...
export class CursoService {
  ...
  public deleteCurso(cursoId: number): Observable<void>{
    return this.http.get<void>(`${this.baseUrl}/${cursoId}`);
  }
  ...
  public criarCurso(cursoId: number, curso: CriarCursoRequest): Observable<Curso>{
    return this.http.post<Curso>(`${this.baseUrl}/${cursoId}`, curso);
  }
}
